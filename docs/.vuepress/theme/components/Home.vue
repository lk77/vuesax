<template>
  <main class="con-home vs-component" :aria-labelledby="heroText ? 'main-title' : undefined">
    ...
    <div class="home">
			<div v-if="heroImage" :class="{'doc-activo':data.doc}" class="doc-img">
        <img :src="heroImage" alt="">
      </div>
			<div :class="{'git-activo':data.git}" class="flaticon-github git-img">
        ...
        <img :src="$withBase('/Discord-Logo-White.svg')" alt="">
			...
			<div :class="{'homeBackgroundComponent':heroBackgroundComponent}" class="home-init">
				<component class="heroBackgroundComponent" :is="heroBackgroundComponent"></component>
				<header class="hero">
			...
			<div class="features" v-if="features && features.length">
						<div class="feature" v-for="feature in features">
							...
							<div class="con-img-feature">
								...
								<img v-if="feature.img" :src="$withBase(heroImage)" alt="">
							</div>
						</div>
					</div>
