...
<!--<template>
  <header class="hero">
    <div v-if="heroImage && data.mounted" class="doc-img" :class="{'doc-activo':data.doc}">
      <HomeHeroImage />
    </div>
    <div v-if="data.mounted" :class="{'git-activo':data.git}" class="flaticon-github git-img"></div>

    <h1 v-if="heroText" id="main-title" v-html="heroText"/>

    <p v-if="tagline" class="description" v-html="tagline"/>
