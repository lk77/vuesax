<template>
  <div class="centex">
    ...
    <vs-button @click="$vs.notify({time:8000,title:'Time 8s (8000)',text:'Lorem ipsum dolor sit amet, consectetur',color:'primary',icon:'query_builder'})" type="flat">Time 8s (8000)</vs-button>
  </div>
</template>
